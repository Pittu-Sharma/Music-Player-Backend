...
async function testHianime() {
    try {
        console.log('Testing Hianime search for "Naruto Shippuden"...');
        const searchRes = await hianime.search('Naruto Shippuden');
        ...
        if (searchRes.results.length > 0) {
            ...
            console.log('No results found for Naruto Shippuden');
        }
    } catch (err) {
